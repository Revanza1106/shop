    ...
    <div className="max-w-[1640px] mx-auto flex justify-between items-center  p-4">
      ...
      <div className="flex items-center ">
        ...
        <div>
         ...
         <span className="text-green-500">Best </span><span className="font-bold">Shop</span>
          </h1>
        </div>
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px] mt-2.5">
      ...
      {/* Cart teature */}
      <button className="items-center bg-black text-white hidden md:flex py-2 hover:border-green-500 hover:bg-green-500 rounded-full border-2">
